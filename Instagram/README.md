...
- display all the users pictures from their feed (to access these pictures you'll need to make a GET request)
  - Look at these links to learn about making a GET request: [jQuery](http://www.w3schools.com/jquery/jquery_ajax_intro.asp) and [AJAX](http://www.w3schools.com/jquery/jquery_ajax_get_post.asp)...
